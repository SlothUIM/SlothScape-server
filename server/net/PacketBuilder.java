...
public class PacketBuilder {
	...
	public PacketBuilder putBytes(byte[] bytes) {
		payload.writeBytes(bytes); // replace `buffer` with your actual backing buffer
	    return this;
	}
	/**
	...
	/**
	 * Makes this builder treat the packet as bare (no opcode/type).
	 * This sets the opcode to -1 and type to FIXED.
	 * @param b 
	 *
	 * @return The PacketBuilder instance, for chaining.
	 */
