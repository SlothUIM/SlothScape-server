...
import server.model.npcs.bosses.EventBoss.EventBossSpawns;
...
public class ShadowBeast {
	...
	enum ShadowBeastSpawn {
	    ...
	    ShadowBeastSpawn(Location loc) {
	        this.loc = loc;
	    }
		public static ShadowBeastSpawn generateLocation() {
		return ShadowBeastSpawn.values()[Misc.random(ShadowBeastSpawn.values().length - 1)];
	}
