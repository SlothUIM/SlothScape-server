...
import server.content.instances.InstancedArea;
import server.content.instances.InstancedAreaManager;
import server.content.instances.SingleInstancedArea;
import server.content.instances.impl.SingleInstancedZulrah;
import server.event.CycleEvent;
import server.event.CycleEventContainer;
import server.event.CycleEventHandler;
import server.model.npcs.NPC;
import server.model.npcs.bosses.zulrah.impl.CreateToxicStageOne;
import server.model.npcs.bosses.zulrah.impl.MageStageEight;
import server.model.npcs.bosses.zulrah.impl.MageStageFive;
import server.model.npcs.bosses.zulrah.impl.MageStageThree;
import server.model.npcs.bosses.zulrah.impl.MeleeStageSix;
import server.model.npcs.bosses.zulrah.impl.MeleeStageTen;
import server.model.npcs.bosses.zulrah.impl.MeleeStageTwo;
import server.model.npcs.bosses.zulrah.impl.RangeStageEleven;
import server.model.npcs.bosses.zulrah.impl.RangeStageFour;
import server.model.npcs.bosses.zulrah.impl.RangeStageNine;
import server.model.npcs.bosses.zulrah.impl.RangeStageSeven;
import server.model.npcs.bosses.zulrah.impl.SpawnZulrahStageZero;
...
//import server.model.players.commands.owner.Object;
import server.server.data.SerializablePair;
