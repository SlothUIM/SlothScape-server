...
public class EliteClue {

    public static final int CASKET_ID = 20543;

    // Elite clues do not have Ciphers.
    ...
    public static int[] getEliteCluePool() {
        int length = ANAGRAM_CLUES.length + CHALLENGE_CLUES.length + COORD_CLUES.length + 
    ...
    public static void openCasket(Player c) {
        ...
        // TODO: Add Elite drop table logic here
