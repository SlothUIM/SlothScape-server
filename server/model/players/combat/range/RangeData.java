...
import server.model.players.combat.PoisonedWeapon;
...
//				// JAVELINS
				...
				// CRYSTAL_BOW
				{ 4212, 250 }, {23901, 250}, {23902, 250}, {23903, 250},  {23983, 250}, { 4214, 250 }, { 4215, 250 }, { 4216, 250 }, { 4217, 250 }, { 4218, 250 }, { 4219, 250 }, { 4220, 250 }, { 4221, 250 }, { 4222, 250 },
				{ 4223, 250 }, };
		for (int l = 0; l < data.length; l++) {
			if (item == data[l][0]) {
				str = data[l][1];
	...
	public static int getRangeProjectileGFX(Player c) {
		...
		if (c.playerEquipment[c.playerWeapon] == 9185 || c.playerEquipment[c.playerWeapon] == 21902  || c.playerEquipment[c.playerWeapon] == 11785 || c.playerEquipment[c.playerWeapon] == 21012)
			return 27;
		int str = -1;
