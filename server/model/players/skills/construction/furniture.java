...
public class furniture {
	public static final int LIT_CANDLE = 34, PLANK = 960, OAK_PLANK = 8778, TEAK_PLANK = 8780,
			...
			COIN = 995, BOW = 1929, RD = 1763, BUCKET_OF_WATER = 1929,SUPERCOMPOST = 6034, PAPYRUS = 970, BUCKET_OF_SAND = 1783, PINK_DYE = 6955, BAGGED_NICE_TREE = 8419;
	public enum Furniture
	{
		...
		MARPLE_TREE(1, 4535, 122, 45, 8177,new int[][] {{8425, 1}}),
		...
		TOOL_STORE_2(22, 6787, 120, 25, 8385, new int[][] {{OAK_PLANK, 2}}, 6786),
		TOOL_STORE_3(22, 6788, 120, 35, 8386, new int[][] {{OAK_PLANK, 2}}, 6787),
		TOOL_STORE_4(22, 6789, 120, 44, 8387, new int[][] {{OAK_PLANK, 2}}, 6788),
		TOOL_STORE_5(22, 6790, 121, 55, 8388, new int[][] {{OAK_PLANK, 2}}, 6789),

		CRAFTING_TABLE_1(23, 6796, 50, 16, 8380, new int[][] {{OAK_PLANK, 4}}),
		CRAFTING_TABLE_2(23, 6797, 100, 25, 8381, new int[][] {{MOLTEN_GLASS, 1}}, 6796),
		CRAFTING_TABLE_3(23, 6798, 175, 34, 8382, new int[][] {{MOLTEN_GLASS, 2}}, 6797),
		CRAFTING_TABLE_4(23, 6799, 240, 42, 8383, new int[][] {{OAK_PLANK, 2}}, 6798),
		...
		BENCH_WITH_VICE(24, 6794, 750, 62, 8378, new int[][] {{OAK_PLANK, 2}, {STEEL_BAR, 1}}, 6793),
		BENCH_WITH_A_LATHE(24, 6795, 1000, 77, 8379, new int[][] {{OAK_PLANK, 2}, {STEEL_BAR, 1}}, 6794),
		...
		OAK_PRIZED_CHEST(41, 13385, 240, 34, 8165, new int[][] {{OAK_PLANK, 4}}),
		TEAK_PRIZED_CHEST(41, 13387, 660, 34, 8166, new int[][] {{TEAK_PLANK, 4},{GOLD_LEAF,4}}),
		MAHOGANY_PRIZED_CHEST(41, 13389, 860, 54, 8167, new int[][] {{MAHOGANY_PLANK, 4},{GOLD_LEAF,4}}),
		 ...
		 * Costume room
		 */
		OAK_TREASURE_CHEST(60, 13285, 450, 48, 9839, new int[][] {{OAK_PLANK, 2}}),
		TEAK_TREASURE_CHEST(60, 13287, 1300, 66, 9840, new int[][] {{TEAK_PLANK, 2}}),
		MAHOGANY_TREASURE_CHEST(60, 13289, 2300, 84, 9841, new int[][] {{MAHOGANY_PLANK, 2}}),
		MAGIC_TREASURE_CHEST(60, 13291, 2300, 84, 9841, new int[][] {{MAHOGANY_PLANK, 2}}),
		...
		MAGIC_CAPE_RACK(65, 18771, 4250, 99, 9822, new int[][] {{MAGIC_STONE, 1}}),
		 ...
		 * Formal Garden
		 */
		EXIT_PORTAL_(74, 4525, 100, 1, 8168, new int[][] {{IRON_BAR, 10}}),
		...
		OAK_HOUSE(101, 26297, 240, 37, 12704, new int[][] {{OAK_PLANK, 4}}),
		TEAK_HOUSE(101, 26298, 360, 48, 12705, new int[][] {{12704, 1},{TEAK_PLANK, 4}}),
		MAHOGANY_HOUSE(101, 26299, 560, 59, 12706, new int[][] {{12705, 1},{MAHOGANY_PLANK, 4}}),
		CONSECRATED_HOUSE(101, 26830, 1560, 70, 12707, new int[][] {{12706, 1},{MAHOGANY_PLANK, 4},{MAGIC_STONE, 1}}),
		DESECRATED_HOUSE(101, 26831, 160, 81, 12708, new int[][] {{12707, 1},{MAHOGANY_PLANK, 1},{LIMESTONE_BRICK, 1}}),
		NATURE_HOUSE(101, 26832, 158, 92, 12709, new int[][] {{12708, 1},{MAHOGANY_PLANK, 1},{BUCKET_OF_WATER, 1},{SUPERCOMPOST, 1}}),
		OAK_FEEDER(100, 26870, 182, 37, 12722, new int[][] {{OAK_PLANK, 3},{1927, 1}}),
		TEAL_FEEDER(100, 26870, 272, 48, 12723, new int[][] {{TEAK_PLANK, 3},{1927, 1}}),
		MAHOGANY_FEEDER(100, 26870, 862, 59, 12724, new int[][] {{MAHOGANY_PLANK, 4},{1927, 1},{GOLD_LEAF, 1}}),
		OAK_SCRATCHING_POST(102, 26858, 1000, 91, 12715, new int[][] {{MAGIC_STONE, 1}}),
		TEAL_SCRATCHING_POST(102, 26859, 1000, 91, 12716, new int[][] {{MAGIC_STONE, 1}}),
		MAHOGANY_SCRATCHING_POST(102, 26860, 1000, 91, 12717, new int[][] {{MAGIC_STONE, 1}}),

		SPIRIT_TREE(104, 29227, 350, 75, 6063, new int[][] {{5375, 10}}),
		OBELISK(104, 20955, 3000, 80, 21788, new int[][] {{21804, 4},{MARBLE_BLOCK, 4}}),
		FAIRY_RING(104, 29362, 535, 85, 20636, new int[][] {{6004, 10},{20609, 1}}),
		SPIRIT_TREE_AND_FAIRY_RING(104, 29422, 885, 95, 20637, new int[][] {{5375, 10},{6004, 10},{20609, 1}}),
		
		POOL_OF_RESTORATION(105, 29237, 706, 65, 20639, new int[][] {{LIMESTONE_BRICK, 5},{BUCKET_OF_WATER, 5},{566, 1000},{559, 1000}}),
		POOL_OF_REVITALISATION(105, 29238, 850, 70, 20640, new int[][] {{20639, 10},{12625, 10}}),
		POOL_OF_REJUVENATION(105, 29239, 900, 80, 20641, new int[][] {{20640, 10},{2434, 10}}),
		FANCY_POOL_OF_REJUVENATION(105, 29240, 1950, 85, 20642, new int[][] {{20641, 10},{3024, 10}}),
		ORNATE_POOL_OF_REJUVENATION(105, 29241, 3107, 90, 20643, new int[][] {{20642, 10},{12905, 10},{GOLD_LEAF, 5},{565, 1000}}),
		

		ZEN_THEME(106, 29247, 474, 65, 20644, new int[][] {{BUCKET_OF_SAND, 6},{PINK_DYE, 1},{BAGGED_NICE_TREE, 1}}),
		MARBLE_PORTAL_NEXUS(110, 33354, 3107, 90, 22705, new int[][] {{20642, 10},{12905, 10},{GOLD_LEAF, 5},{565, 1000}}),
		GILDED_PORTAL_NEXUS(110, 33395, 3107, 90, 22706, new int[][] {{20642, 10},{12905, 10},{GOLD_LEAF, 5},{565, 1000}}),
		CRYSTALLINE_PORTAL_NEXUS(110, 33410, 3107, 90, 22707, new int[][] {{20642, 10},{12905, 10},{GOLD_LEAF, 5},{565, 1000}}),
		

		BASIC_JEWELLERY_BOX(115, 37492, 3107, 90, 20626, new int[][] {{20642, 10},{12905, 10},{GOLD_LEAF, 5},{565, 1000}}),
		FANCY_JEWELLERY_BOX(115, 37501, 3107, 90, 20627, new int[][] {{20642, 10},{12905, 10},{GOLD_LEAF, 5},{565, 1000}}),
		ORNATE_JEWELLERY_BOX(115, 37520, 3107, 90, 20628, new int[][] {{20642, 10},{12905, 10},{GOLD_LEAF, 5},{565, 1000}}),

		MOUNTED_EMBLEM(116, 29164, 5300, 80, 20630, new int[][] {{MARBLE_BLOCK, 1},{GOLD_LEAF, 1},{29287, 1}}),
		MOUNTED_COINS(116, 29165, 800, 80, 20631, new int[][] {{MARBLE_BLOCK, 1},{GOLD_LEAF, 1},{995, 100000000}}),
		CAPE_HANGER(116, 29166, 800, 80, 20632, new int[][] {{MARBLE_BLOCK, 1},{GOLD_LEAF, 1}}),

		MAHOGANY_ADVENTURE_LOG(118, 29151, 504, 83, 20622, new int[][] {{MAHOGANY_PLANK, 3},{PAPYRUS, 2},{4155, 1}}),
		GILDED_ADVENTURE_LOG(118, 29152, 1100, 88, 20623, new int[][] {{MAHOGANY_PLANK, 3},{GOLD_LEAF, 2},{4155, 1}}),
		MARBLE_ADVENTURE_LOG(118, 29153, 1160, 93, 20624, new int[][] {{MARBLE_BLOCK, 2},{LIMESTONE_BRICK, 4}, {4155, 1}}),
		;
