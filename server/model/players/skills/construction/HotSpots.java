...
import server.model.players.skills.construction.util.Size;
...
public enum HotSpots
{
	...
	TIP_JAR(6, 29119, 0, 0 ,0, ConstructionData.GARDEN),
	/**
	 * Parlour
	 */
	PARLOUR_CHAIR_1(6, 4515, 2, 4, 2, ConstructionData.PARLOUR, 11),
	PARLOUR_CHAIR_2(6, 4517, 4, 3, 2, ConstructionData.PARLOUR),
	PARLOUR_CHAIR_3(6, 4516, 5, 4, 1, ConstructionData.PARLOUR, 11),
	PARLOUR_RUG_1(7, 4520, 2, 2, 0, ConstructionData.PARLOUR, 22, new Size(5, 5)),
	PARLOUR_RUG_2(7, 4519, 2, 2, 0, ConstructionData.PARLOUR, 22, new Size(5, 5)),
	PARLOUR_RUG_3(7, 4518, 2, 2, 0, ConstructionData.PARLOUR, 22, new Size(5, 5)),
	PARLOUR_BOOKCASE_1(8, 4521, 0, 1, 0, ConstructionData.PARLOUR),
	PARLOUR_BOOKCASE_2(8, 4521, 7, 1, 2, ConstructionData.PARLOUR),
	PARLOUR_FIREPLACE(9, 4523, 3, 7, 1, ConstructionData.PARLOUR),
	PARLOUR_CURTAIN_1(10, 4524, 0, 2, 0, ConstructionData.PARLOUR, 5, true),
	PARLOUR_CURTAIN_2(10, 4524, 0, 5, 0, ConstructionData.PARLOUR, 5, true),
	PARLOUR_CURTAIN_3(10, 4524, 2, 7, 1, ConstructionData.PARLOUR, 5, true),
	PARLOUR_CURTAIN_4(10, 4524, 5, 7, 1, ConstructionData.PARLOUR, 5, true),
	PARLOUR_CURTAIN_5(10, 4524, 7, 5, 2, ConstructionData.PARLOUR, 5, true),
	PARLOUR_CURTAIN_6(10, 4524, 7, 2, 2, ConstructionData.PARLOUR, 5, true),
	PARLOUR_CURTAIN_7(10, 4524, 5, 0, 3, ConstructionData.PARLOUR, 5, true),
	PARLOUR_CURTAIN_8(10, 4524, 2, 0, 3, ConstructionData.PARLOUR, 5, true),
	...
	KITCHEN_SHELF_1(17, 15400, 1, 7, 1, ConstructionData.KITCHEN, 5, true),
	KITCHEN_SHELF_2(17, 15400, 6, 7, 1, ConstructionData.KITCHEN, 5, true),
	KITCHEN_SHELF_3(17, 15399, 7, 6, 2, ConstructionData.KITCHEN, 5, true),
	 ...
	 * Bedroom
	 */
	BEDROOM_RUG_1(7, 15266, 2, 2, 0, ConstructionData.BEDROOM, 22, new Size(5, 3)),
	BEDROOM_RUG_2(7, 15265, 2, 2, 0, ConstructionData.BEDROOM, 22, new Size(5, 3)),
	BEDROOM_RUG_3(7, 15264, 2, 2, 0, ConstructionData.BEDROOM, 22, new Size(5, 3)),
	 ...
	 * Skill hall
	 */
	SKILL_HALL_RUG_1(7, 15379, 2, 2, 0, ConstructionData.SKILL_ROOM, 22, new Size(5, 5)),
	SKILL_HALL_RUG_2(7, 15378, 2, 2, 0, ConstructionData.SKILL_ROOM, 22, new Size(5, 5)),
	SKILL_HALL_RUG_3(7, 15377, 2, 2, 0, ConstructionData.SKILL_ROOM, 22, new Size(5, 5)),
	...
	SKILL_HALL_RUG_1_DOWN(7, 15379, 2, 2, 0, ConstructionData.SKILL_HALL_DOWN, 22, new Size(5, 5)),
	SKILL_HALL_RUG_2_DOWN(7, 15378, 2, 2, 0, ConstructionData.SKILL_HALL_DOWN, 22, new Size(5, 5)),
	SKILL_HALL_RUG_3_DOWN(7, 15377, 2, 2, 0, ConstructionData.SKILL_HALL_DOWN, 22, new Size(5, 5)),
	...
	QUEST_HALL_RUG_1(7, 15389, 2, 2, 0, ConstructionData.QUEST_ROOM, 22, new Size(5, 5)),
	QUEST_HALL_RUG_2(7, 15388, 2, 2, 0, ConstructionData.QUEST_ROOM, 22, new Size(5, 5)),
	QUEST_HALL_RUG_3(7, 15387, 2, 2, 0, ConstructionData.QUEST_ROOM, 22, new Size(5, 5)),
	...
	QUEST_HALL_RUG_1_DOWN(7, 15389, 2, 2, 0, ConstructionData.QUEST_HALL_DOWN, 22, new Size(5, 5)),
	QUEST_HALL_RUG_2_DOWN(7, 15388, 2, 2, 0, ConstructionData.QUEST_HALL_DOWN, 22, new Size(5, 5)),
	QUEST_HALL_RUG_3_DOWN(7, 15387, 2, 2, 0, ConstructionData.QUEST_HALL_DOWN, 22, new Size(5, 5)),
	
	/**
	 * Menagerie
	 */
	MENAGERIE_PET_HOUSE(50, 44909, 1, 1, 2, ConstructionData.MENAGERIE),
	MENAGERIE_PET_FEEDER(51, 44910, 5, 1, 3, ConstructionData.MENAGERIE),
	MENAGERIE_OBELISK(52, 44911, 5, 5, 3, ConstructionData.MENAGERIE),
	
	HABITAT_SPACE(53, 44908, 0, 0, 0, ConstructionData.MENAGERIE),
	...
	STUDY_CRYSTAL_BALL(57, 15422, 5, 2, 0, ConstructionData.STUDY),
	...
	CHAPEL_RUG_2(7, 15274, 4, 1, 0, ConstructionData.CHAPEL, 22, new Size(1, 4)),
	CHAPEL_RUG_3(7, 15273, 4, 1, 0, ConstructionData.CHAPEL, 22, new Size(1, 4)),
	...
	PET_FEEDER(100, 26869, 0, 7, 3, ConstructionData.MENAGERIE, 10),
	PET_HOUSE(101, 26296, 4, 4, 3, ConstructionData.MENAGERIE, 10),
	SCRATCHING_POST(102, 26857, 6, 7, 3, ConstructionData.MENAGERIE, 10),
	HABITAT(103, 26839, 0, 0, 0, ConstructionData.MENAGERIE),
	HABITAT_EDGE(103, 26851, 0, 0, 0, ConstructionData.MENAGERIE),

	TELEPORT_SPACE(104, 29120, 3, 3, 2, ConstructionData.SUPERIOR_GARDEN, 10),
	POOL_SPACE(105, 29122, 6, 0, 1, ConstructionData.SUPERIOR_GARDEN, 10),
	THEME_SPACE(106, 29130, 6, 6, 2, ConstructionData.SUPERIOR_GARDEN, 10),//29247
	THEME_SPACE_FLOOR_1(106, 26841, 6, 6, 0, ConstructionData.SUPERIOR_GARDEN, 22, new Size(5, 5)),//29242
	THEME_SPACE_FLOOR_2(106, 26847, 6, 6, 0, ConstructionData.SUPERIOR_GARDEN, 22, new Size(5, 5)),//29244

	PORTAL_NEXUS_SPACE(110, 33346, 3, 3, 1, ConstructionData.PORTAL_NEXUS, 10),
	

	JEWELLERY_BOX_SPACE(115, 29142, 6, 1, 1, ConstructionData.ACHIEVEMENT_GALLERY, 10),
	DISPLAY_SPACE(116, 29144, 6, 6, 1, ConstructionData.ACHIEVEMENT_GALLERY, 10),
	ALTAR_SPACE(117, 29140, 1, 3, 2, ConstructionData.ACHIEVEMENT_GALLERY, 10),
	ADVENTURE_LOG_SPACE(118, 29141, 0, 0, 1, ConstructionData.ACHIEVEMENT_GALLERY, 10),
	;
	public int hotSpotId, objectId, xOffset, yOffset, standardRotation,
			objectType, roomType;
	private boolean mutiple;
	private Size carpetDim;
	...
	private HotSpots(int hotSpotId, int objectId, int xOffset, int yOffset,
			int standardRotation, int roomType, int objectType, Size carpetDim) {
		this(hotSpotId, objectId, xOffset, yOffset, standardRotation, roomType,
				objectType);
	...
	public static HotSpots forHotSpotIdAndCoords(int hotSpotId, int xOffset, int yOffset, RoomData room) {
		for (HotSpots hs : values()) {
	...
	public int getRotation(int roomRot) {
	    return (standardRotation + roomRot) & 3;
	}

	public static int getRotation_2(int rot, int roomRot) {
	    return (rot + roomRot) & 3;
	}
	...
	public Size getCarpetDim() {
		return carpetDim;
	}

	public void setCarpetDim(Size carpetDim) {
