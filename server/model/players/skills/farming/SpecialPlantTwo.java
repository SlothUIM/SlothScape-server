...
public class SpecialPlantTwo {
	...
	public SpecialPlantTwo(Player player2) {
		this.player = player2;
	}
	...
	public boolean clearPatch(int objectX, int objectY, int itemId) {
		...
		CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
            ...
            public void execute(CycleEventContainer container) {
				...
				specialPlantTimer[hopsFieldsData.getSpecialPlantsIndex()] = Server
						.getMinutesCounter();
				updateSpecialPlants();
				if (specialPlantStages[hopsFieldsData.getSpecialPlantsIndex()] == 3) {
					container.stop();
	...
	public boolean plantSeeds(int objectX, int objectY, final int seedId) {
		...
		if (player.getItems().getItemAmount(specialPlantData.getSeedId()) < specialPlantData
				.getSeedAmount()) {
			player.getDH().sendStatement2( "You need atleast "
		...
		player.getItems().deleteItem(seedId, specialPlantData.getSeedAmount());
	...
	public boolean harvestOrCheckHealth(int objectX, int objectY) {
		...
		CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
            ...
            public void execute(CycleEventContainer container) {
				...
				player.getItems().addItem(specialPlantData.getHarvestId(), 1);
