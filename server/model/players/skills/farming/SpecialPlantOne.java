...
public class SpecialPlantOne {
	...
	public SpecialPlantOne(Player player2) {
		this.player = player2;
	}
	...
	public boolean plantSapling(int objectX, int objectY, final int saplingId) {
		...
		if (specialPlantData.getLevelRequired() > player.playerLevel[player.playerFarming]) {
			player.getDH().sendStatement2("You need a farming level of "
		...
		player.getItems().deleteItem(saplingId, 1);
		...
		CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
            ...
            public void execute(CycleEventContainer container) {
				...
				specialPlantTimer[specialPlantFieldData.getSpecialPlantsIndex()] = Server
						.getMinutesCounter();
				player.getPA().addSkillXP((int)specialPlantData.getPlantingXp(), player.playerFarming);
				container.stop();
			}
		...
		CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
            ...
            public void execute(CycleEventContainer container) {
				...
				if (specialPlantState[specialPlantFieldsData
					...
					player.getPA().addSkillXP((int)specialPlantData.getCheckHealthXp(), player.playerFarming);
					specialPlantState[specialPlantFieldsData
				...
				player.getPA().addSkillXP((int)specialPlantData.getHarvestXp(), player.playerFarming);
	...
	public boolean inspect(int objectX, int objectY) {
		...
		if (specialPlantState[specialPlantFieldsData.getSpecialPlantsIndex()] == 1) {
			player.getDH().sendStatement2("This plant is diseased. Use a plant cure on it to cure it, ",
							"or clear the patch with a spade.");
			return true;
		} else if (specialPlantState[specialPlantFieldsData
				.getSpecialPlantsIndex()] == 2) {
			player.getDH().sendStatement2("This plant is dead. You did not cure it while it was diseased.",
		...
		if (specialPlantStages[specialPlantFieldsData.getSpecialPlantsIndex()] == 0) {
			player.getDH().sendStatement2("This is one of the special patches. The soil has not been treated.",
			...
			CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
	            ...
	            public void execute(CycleEventContainer container) {
					if (specialPlantStages[specialPlantFieldsData
						...
						player.getDH().sendStatement2(inspectData.getMessages()[specialPlantStages[specialPlantFieldsData
