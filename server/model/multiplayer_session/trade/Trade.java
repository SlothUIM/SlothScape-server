package server.model.multiplayer_session.trade;
...
import server.model.multiplayer_session.Multiplayer;
...
//			return false;
//		}
		if (System.currentTimeMillis() - player.lastTradeRequest < 5000) {
		    player.sendMessage("You must wait a few seconds before sending another trade request.");
		    return false;
		}

		// If they pass the check, update the timer and send the request
		player.lastTradeRequest = System.currentTimeMillis();
