...
public class Item {
	...
	private boolean stackable;	public Item(int id) {
		this.id = id;
		this.amount = 1;
		if (itemStackable[id]) {
			stackable = true;
	...
	public static int capes[] = { 2731, 2677, 2683, 2680, 2701, 2686, 2689,
			...
			4409, 4411, 4413, 4514, 4516, 6070, 6568, 6570, 13121, 13122, 13123, 13124, 12437, 12427 };
	public static int boots[] = { 7596, 8029, 6619, 8017, 7159, 7991, 6666,
			...
			6357, 3393, 12391,11840,11836,13589,13644, 12598};
	public static int gloves[] = { 7595, 6629, 8021, 8016, 7964, 2491, 1065,
			...
			7454, 7455, 7456, 7457, 7458, 7459, 7460, 7461, 7462, 6330, 3391,13587 };
	public static int shields[] = { 7676, 7342, 7348, 7354, 7360, 7334, 7340,
			...
			6263, 6265, 6267, 6269, 6271, 6273, 6275, 6277, 6279, 6524, 6889, 12954, 12817 };
	public static int hats[] = { 2679, 2685, 2682, 2703, 2688, 2691, 2691,
			...
			7003, 10828, 12931, 12929, 21018,19647 };
	public static int amulets[] = { 1654, 1656, 1658, 1660, 1662, 1664, 8081,
			...
			6859, 6863, 6857,19553, 19547, 19541, 19535 };
	...
	public static int rings[] = { 8082, 773, 1635, 1637, 1639, 1641, 1643,
			...
			2570, 2572, 4202, 4657, 6465, 6737, 6731, 6735, 6735, 6583, 6733, 19550, 19538, 
			12601, 12603, 12605};
	...
	public static int legs[] = { 7609, 2522, 7378, 7380, 7382, 7368, 7366,
			...
			3387, 5036, 5038, 5040, 11726, 11722, 13640, 21024};
	public static int platebody[] = { 10338, 7608, 2520, 430, 636, 638, 640,
			...
			5575, 6341, 6351, 3387, 5030, 5032, 5034, 7392, 10386 , 10378, 10370, 13642, 13643,12508};
	...
	private static String[] fullbody = { "top", "shirt", "platebody",
			...
			"hauberk", "Dragon chainbody" , "Saradomin d'hide", "Guthix_dragonhide", "Zamorak d'hide", "ele' shirt", "ele' blouse","Armadyl d'hide body"};
	...
	private static String[] fullhat = { "med helm", "coif", "Dharok's helm",
			...
			"Warrior helm", "Void", "Serpentine helm", "Ram skull helm", "Slayer helmet"," slayer helmet"  ,"Sleeping cap","A powdered wig", "Neitiznot faceguard"};
	...
	private static String[] fullmask = { "full helm", "mask", "Verac's helm",
			...
			"sallet", "Serpentine helm", "Zombie mask", "Slayer helmet"," slayer helmet", " full helm (g)", "Neitiznot faceguard","Graceful hood"};
	private static String[] cape = { "Cloak", "cloak", "cape",
			"Cape", "ava's", "backpack", "Bonesack" ,"Max cape"};
	//private static String[] fullmask = { "full helm", "mask", "Verac's helm",
			//"Guthan's helm", "Karil's coif", "mask", "Torag's helm", "Void",
			//"sallet", "Serpentine helm" };

	public static boolean isFullBody(int itemId) {
		String weapon = getItemName(itemId);
		if (weapon == null || itemId == -1)
			return false;
	...
	public static boolean isLegsBody(int itemId) {
	...
	public static boolean isCape(int itemId) {
		String capes = getItemName(itemId);
		if (capes == null)
			return false;
		for (int i = 0; i < cape.length; i++) {
			if (capes.contains(cape[i])) {
				return true;
			}
		}
		return false;
	...
	public Optional<ItemList> getDefinition() {
		if(id < 0 || id > World.getWorld().itemHandler.ItemList.length)
			return Optional.empty();
		return Optional.ofNullable(World.getWorld().itemHandler.ItemList[id]);
	}
		...
		try {
			...
			while ((c = dataIn.read()) != -1) {
				if (c == 0) {
					...
					itemStackable[19496] = true;
					itemStackable[19494] = true;
					itemStackable[19498] = true;
					itemStackable[19502] = true;
					itemStackable[12728] = true;
					itemStackable[12730] = true;
					itemStackable[12732] = true;
					itemStackable[12734] = true;
					itemStackable[12736] = true;
					itemStackable[12738] = true;
					itemStackable[21880] = true;
					itemStackable[20545] = true;
					itemStackable[20546] = true;
					itemStackable[20547] = true;
					itemStackable[20548] = true;
					
					itemStackable[11849] = true;
					itemStackable[12775] = true;
					itemStackable[12776] = true;
					itemStackable[12777] = true;
					itemStackable[12778] = true;
					itemStackable[12779] = true;
					itemStackable[12780] = true;
					itemStackable[12781] = true;
					itemStackable[12782] = true;
					itemStackable[22879] = true;
					itemStackable[22521] = true;
					itemStackable[20849] = true;
				} else {
