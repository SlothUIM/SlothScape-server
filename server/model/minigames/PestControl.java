...
public class PestControl {
	...
	public void spawnNpcs() {
		World.getWorld().getNpcHandler().spawnNpc2(3777, 2628, 2591, 0, 0, 200, 0, 0, 100);
		World.getWorld().getNpcHandler().spawnNpc2(3778, 2680, 2588, 0, 0, 200, 0, 0, 100);
		World.getWorld().getNpcHandler().spawnNpc2(3779, 2669, 2570, 0, 0, 200, 0, 0, 100);
		World.getWorld().getNpcHandler().spawnNpc2(3780, 2645, 2569, 0, 0, 200, 0, 0, 100);
	}
