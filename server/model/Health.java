...
import server.event.impl.PoisonEvent;
import server.event.impl.PoisonResistanceEvent;
import server.event.impl.VenomEvent;
import server.event.impl.VenomResistanceEvent;
...
public final class Health {
	...
	public void reduce(int amount) {
		/*if (entity instanceof Player) {
			Player player = (Player) entity;
			player.getNpcHandler().ringOfLife(player);
		}*/
		if (amount <= 0) {
			return;
		}
