...
//import server.content.BonusActivation;
...
public class ServerData{
	...
	private void loadServerData() {
		initializeVariables();	
		File serverFolder = new File("./Data/serv/");
	...
	public synchronized void saveField(Field field) {
		...
		File tempFile = new File("./Data/serv/" + field.getName() + ".tmp");
		tempFile.delete();
		try {
			ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream(tempFile));
			out.writeObject(field.get(this));
			out.close();
			new File("./Data/serv/" + field.getName() + ".var").delete();
			tempFile.renameTo(new File("./Data/serv/" + field.getName() + ".var"));
