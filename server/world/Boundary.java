...
public class Boundary {
	...
	public List<Location> getRandomLocations(int count, int height) {
		...
		while (locations.size() < count && lock-- > 0) {
			...
			location.getRegion();
			if (!Region.solidObjectExists(x, y, height) && !locations.contains(location)) {
	...
	public boolean isIn(int x, int y, int height) {
	    if (this.height >= 0 && height != this.height) {
	        return false;
	    }
	    return x >= minX && x <= highX && y >= minY && y <= highY;
	}
	...
	public static final Boundary ARDOUGNE_FARM_BOUNDARY = new Boundary(2644, 3358, 2680, 3387);
	public static final Boundary CATHERBY_FARM_BOUNDARY = new Boundary(2767, 3392, 2864, 3521);
	public static final Boundary FALADOR_FARM_BOUNDARY = new Boundary(2935, 3310, 3066, 3394);
	public static final Boundary PHASMATYS_FARM_BOUNDARY = new Boundary(3471, 3462, 3516, 3514);
	...
	public static final Boundary FISHING_TRAWLER = new Boundary(1880, 4810, 2020, 4840);
	...
	public static final Boundary THEATRE_LOBBY_ENTRANCE = new Boundary(3642,3204,3683,3234);
...
public static final Boundary SOLAK_AREA = new Boundary(3154, 9746, 3193, 9777);
	...
	public static final Boundary FEROX_ENCLAVE = new Boundary(3125, 3617, 3155, 3640);
	...
	public static final Boundary REVENANT_CAVE_2 = new Boundary(1600, 5312, 64, 64);
...
//public static final Boundary WILDERNESS = new Boundary(1486, 1444, 3767, 3730);
	...
	public static final Boundary MULTI = new Boundary(3287, 4439, 3304, 4456);

	public static final Boundary[] NO_FIREMAKING = { EDGE_BANK, BLOAT_ARENA, };
